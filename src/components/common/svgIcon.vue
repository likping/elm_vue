    ...
    >
        <defs>
            ...
            <symbol viewBox="0 0 40 40" id="order">
                <path
                    d="M31.5 3h-23C6 3 4 5.1 4 7.7v24.7C4 34.9 6 37 8.5 37h23c2.5 0 4.5-2.1 4.5-4.7V7.7C36 5.1 34 3 31.5 3zM11.8 28.2c-1.1 0-2-.9-2-2.1 0-1.1.9-2.1 2-2.1s2 .9 2 2.1c0 1.2-.9 2.1-2 2.1zm0-6.1c-1.1 0-2-.9-2-2.1 0-1.1.9-2.1 2-2.1s2 .9 2 2.1c0 1.1-.9 2.1-2 2.1zm0-6.2c-1.1 0-2-.9-2-2.1 0-1.1.9-2.1 2-2.1s2 .9 2 2.1c0 1.2-.9 2.1-2 2.1zm5.1 11.9h13.5v-2.6H16.9v2.6zm0-6.5h13.5v-2.6H16.9v2.6zm0-6.6h13.5v-2.6H16.9v2.6z"
                />
            </symbol>
            ...
            <symbol viewBox="0 0 40 40" id="vip">
                ...
                <path
                    ...
                    class="st0"
                />
                <ellipse cx="20.1" cy="8.2" rx="3.2" ry="3.2" />
                <ellipse cx="6.4" cy="10.5" rx="2.4" ry="2.4" />
                <ellipse cx="33.8" cy="10.5" rx="2.4" ry="2.4" />
            </symbol>
            ...
            >
                ...
                <g fill="none" fill-rule="evenodd">
                    <mask id="sdk_icon_zhifubao@2x_b" fill="#fff">
                        <use xlink:href="#sdk_icon_zhifubao@2x_a" />
                    </mask>
                    <use fill="#00A1E9" xlink:href="#sdk_icon_zhifubao@2x_a" />
                    <path
            ...
            <symbol viewBox="0 0 72 72" id="weixin">
                <g fill="none" fill-rule="evenodd">
                    <path
                        d="M36 72c19.882 0 36-16.118 36-36S55.882 0 36 0 0 16.118 0 36s16.118 36 36 36z"
                        fill="#45C144"
            ...
            <symbol viewBox="0 0 46 46" id="human">
                <path
                    fill="#ff7b52"
            ...
            <symbol viewBox="0 0 46 46" id="phone">
                <path
                    fill="#6ac20b"
